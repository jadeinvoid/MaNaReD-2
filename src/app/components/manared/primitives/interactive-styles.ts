...
/** Pointer hover — stacks `--shadow-button-hover` on top of any rest shadow. */
...
export const INTERACTIVE_CHIP_BAR_CONTROL = `inline-flex h-7 shrink-0 items-center justify-center gap-1 rounded-lg border border-solid border-border-secondary bg-body px-[length:var(--spacing-2)] py-[length:var(--spacing-1)] text-3xs font-normal text-secondary ${BUTTON_ELEVATION_HOVER} focus-visible:bg-button-focus focus-visible:outline-none`;
...
export const INTERACTIVE_CHIP_BAR_VIEW_SEGMENT = `inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-md text-secondary ${BUTTON_ELEVATION_HOVER} focus-visible:bg-button-focus focus-visible:outline-none`;
...
export const INTERACTIVE_FILTER_ACTION_BASE = `inline-flex shrink-0 items-center justify-center rounded-md border border-solid bg-button-active font-normal text-primary ${BUTTON_ELEVATION_HOVER} focus-visible:bg-button-focus focus-visible:outline-none`;
...
const CARD_FOOTER_BUTTON_BASE = `inline-flex shrink-0 items-center justify-center rounded-[6px] border border-solid px-3 py-1.5 text-3xs font-normal leading-normal text-primary ${BUTTON_ELEVATION_HOVER} focus-visible:bg-button-focus focus-visible:outline-none`;
