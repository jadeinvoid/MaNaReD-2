...
/** 24px icon frame — Figma `icon/compound` slot; overflow visible so inset artwork is not clipped. */
export const LIST_ROW_ICON_SLOT = "relative size-6 shrink-0 overflow-visible";
