...
export const manaredTheme = defineTheme({
  ...
  tokens: {
    ...
    // Interactive button pointer hover — shadow hue from --color-shadow (subtler than --shadow-elevated)
    "--shadow-button-hover": "0 4px 8px color-mix(in srgb, var(--color-shadow) 8%, transparent)",
