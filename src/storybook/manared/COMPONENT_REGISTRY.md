...
| NavSideBar             | Composites  | `composites/nav-side-bar.tsx`        | `339:3237` | done   | `gradient-styles`, `manaredElevation.css`                  | 192px width; category + indented sub-items; logo slot; expand header        |
...
| FilterSidebar          | Composites  | `composites/filter-sidebar.tsx`      | `349:4572` | done   | `gradient-styles`                                          | Figma `filter/container`; chevron-down rows; Clear All footer               |
