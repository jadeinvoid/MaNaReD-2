...
| FilterTagPanel         | Composites  | `composites/filter-tag-panel.tsx`      | `166:998`  | done   | `entity-styles.ts`                                              | Bioactivity + target/assay tag multi-select; compound styling; counts, search |
