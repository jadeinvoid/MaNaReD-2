...
| SearchBar              | Composites  | `composites/search-bar.tsx`          | `332:9047` | done   | `surface-styles.ts`                                        | `TextInput` client island; light/dark play tests                            |
...
| TopBar                 | Composites  | `composites/top-bar.tsx`             | `332:9045` | done   | `surface-styles.ts`                                        | Composes `SearchBar`; light/dark play tests                                 |
