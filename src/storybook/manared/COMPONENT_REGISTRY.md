...
| FilterTagPanel         | Composites  | `composites/filter-tag-panel.tsx`      | `166:998`  | done   | `entity-styles.ts`                                              | Bioactivity tag multi-select; compound entity styling                       |
...
| FilterSidebar          | Composites  | `composites/filter-sidebar.tsx`        | `349:4572` | done   | `gradient-styles`, `filter-state.ts`                            | Client island; accordion; `onFiltersChange`; Clear All                      |
