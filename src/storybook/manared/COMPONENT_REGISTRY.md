...
| CompoundCard           | Domain      | `domain/compound-card.tsx`           | `367:4387` | done   | `surface-styles`, `card-text-styles`, `interactive-styles` | Full card + metadata grid + footer actions; light/dark play tests |
