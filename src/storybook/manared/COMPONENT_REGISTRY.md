...
| EntityNav              | Composites  | `composites/entity-nav.tsx`          | UX §11     | done   | Astryx `SegmentedControl`                                  | Compounds \| Organisms \| Regions                                           |
| TopBarRegion           | Composites  | `composites/top-bar-region.tsx`      | `340:3751` | done   | composes TopBar + EntityNav                                | UX shell header region                                                      |
| NavSideBar             | Composites  | `composites/nav-side-bar.tsx`        | `339:3237` | done   | `gradient-styles`                                          | `showExplore` prop for UX-aligned shell                                     |
